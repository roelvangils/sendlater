...
<p><strong>What:</strong> A random minute between 08:00 and 08:45, today or on the next workday.</p>
<p><strong>When:</strong> For the "I'm writing way too late" case. Label your draft at 00:30 on Monday → it sends the same Monday morning (not Tuesday, like <span class="chip">Send Later/Tomorrow</span> would). Label at 14:00 → next workday morning. Weekends are skipped. The random minute makes the send feel less robotic than a pin-point 08:00.</p>
</div>
